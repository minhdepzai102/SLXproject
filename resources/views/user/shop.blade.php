...
.templatemo-accordion .open > ul {
    display: block; /* Show child menus when open class is added */
}
...
<body>
    ...
    @foreach ($menus->where('parent_id', 0) as $parentMenu)
        <li class="pb-3">
            <a class="d-flex justify-content-between h3 text-decoration-none toggle-submenu" href="javascript:void(0);">
                {{ $parentMenu->name }}
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        @foreach ($menus->where('parent_id', 0) as $parentMenu)
                            ...
                            <a class="h3 text-dark text-decoration-none mr-3" href="#">{{ $parentMenu->name }}</a>
                            </li>
                        @endforeach
                        </ul>
                    </div>
